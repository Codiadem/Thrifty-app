      ...
      <div className="footer-container">
        <div className="flex footer font-bold justify-around">
          <div className="text-white mt-20 mr-40">
            ...
            <p className=" w-64">
              Download Thrifty for free on the iOS and Google Play stores, or
        ...
        <div className="ul text-white" id="contact">
          <ul className="linking">
            ...
            <li>
              <a href="#">How To Cancel</a>
            </li>
            <li>
              <a href="#">Bill Negotiation</a>
            </li>
            <li>
        ...
        <p className="copy">
          ©<i>2024 Thrifty. All Rights Reserved</i>
        </p>
      </div>
    </>
  );
