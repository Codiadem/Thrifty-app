  ...
  return (
    <>
      <div className="bg-blue cont">
        <h1 className="text-center text-4xl font-semibold pt-8 text-white">
          Testimonials
        </h1>
              ...
              {data.map((d, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col justify-center items-center gap-4 p-4">
                    ...
                    <p>{d.review}</p>
                    <button className="bg-primaryBlue text-white text-lg px-6 py-1 rounded-xl">
                      Read More
                    </button>
                  </div>
                </div>
...
const data = [
  {
    ...
    review:
      "Thrifty is a very user friendly app that has really helped in keeping track of my expenditures and im grateful for that",
  },
  {
    name: `Keziah Ching`,
